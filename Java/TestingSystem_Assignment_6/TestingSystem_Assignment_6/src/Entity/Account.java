...
public class Account {
    ...
    private void input() {
        ...
        id = ScannerUtils1.inputInt1("Please input a number as int, please input again.");

        System.out.println("Nhập email: ");
        email = ScannerUtils1.inputString("Please input a email, please input again.");

        System.out.println("Nhập username: ");
        username = ScannerUtils1.inputString("Please input a String, please input again.");

        System.out.println("Nhập fullname: ");
        fullname = ScannerUtils1.inputString("Please input a String, please input again.");
...
//	Khi người dùng nhập vào tuổi <= 0 thì throw ra Exception  InvalidAgeInputingException với message là: "The age must be greater than 0"
    private int inputAge() throws InvalidAgeInputingException {
        int age = ScannerUtils1.inputInt1("Please input an age as int, please input again.");
