...
public class Group {
    ...
    private void input() {
        ...
        id = ScannerUtils1.inputInt1("Please input a group id as int, please input again.");

        System.out.println("Nhập tên : ");
        name = ScannerUtils1.inputString("Please input a group name, please input again.");
    ...
    private void confirmAddAccount() {
        ...
        int choose;
        while (true) {
            choose = ScannerUtils1.inputInt1("Please input a number as int");
    ...
    private void addAccount() {
        ...
        int n = ScannerUtils1.inputInt1("Please input a number as int, please input again.");
