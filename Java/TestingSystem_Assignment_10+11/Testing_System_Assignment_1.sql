DROP DATABASE IF EXISTS Testing_System_Assignment_1;	-- xoá database nếu nó đang tồn tại
CREATE DATABASE Testing_System_Assignment_1; 	-- tạo database
USE Testing_System_Assignment_1;	-- sử dụng database  vừa tạo
...
DELIMITER $$
CREATE PROCEDURE sp_delete_department(IN cp_DepartmentID INTEGER)
BEGIN
	DELETE FROM `Department` WHERE DepartmentID = cp_DepartmentID;
END $$
DELIMITER ;
